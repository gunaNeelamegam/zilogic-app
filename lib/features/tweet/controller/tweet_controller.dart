...
import 'package:zilogic/apis/storage_api.dart';
import 'package:zilogic/apis/tweet_api.dart';
...
import 'package:zilogic/features/notifications/controller/notification_controller.dart';
...
class TweetController extends StateNotifier<bool> {
  ...
  void _shareImageTweet({
    ...
    debugPrint("Share tweet Response : $res");

    res.fold((l) {
      debugPrint("${l.message} ${l.stackTrace.toString()}");
